...
## Chạy BE (local) + FE (do BE phục vụ) + Mongo (local)
### Chuẩn bị MongoDB (tuỳ chọn 1)
...
```
## Chạy toàn bộ bằng Docker Compose (khuyên dùng)
